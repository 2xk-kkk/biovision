...
def get_all_posts(page=1, page_size=20, sort_by='create_at', sort_order='desc', tag=None):
    db = get_db_connection()
    try:
        posts_data = get_posts_with_counts(db, page, page_size, sort_by, sort_order, tag)
